...
public class S3D_GL3_FractalBitmapOrbitTrapping_PointSprites extends BaseRoutineAdapter implements BaseRoutineInterface,BaseFrameBufferObjectRendererInterface {
    ...
    public void mainLoop_FBORenderer(int inFrameNumber,GL2 inGL,GLU inGLU,GLUT inGLUT) {
        ...
        int tCurrentTransform = 3;
        if (tCurrentTransform==0) {
            inGL.glTranslatef(0+BaseRoutineRuntime.getInstance().getCurrentStereoscopicEyeSeparation(), 0, -250.0f);
            ...
            inGL.glTranslatef(0+BaseRoutineRuntime.getInstance().getCurrentStereoscopicEyeSeparation(), 0, -150.0f);
            inGL.glRotatef(inFrameNumber*0.2f, 0f, 1f, 0f);
            //inGL.glRotatef(inFrameNumber*0.2f, 1f, 0f, 0f);
            //inGL.glRotatef(inFrameNumber*0.3f, 0f, 0f, 1f);                  
        } else if(tCurrentTransform==2) {
            inGL.glTranslatef(0+BaseRoutineRuntime.getInstance().getCurrentStereoscopicEyeSeparation(), BaseGlobalEnvironment.getInstance().getParameterKey_FLOAT_DF(), -150.0f+BaseGlobalEnvironment.getInstance().getParameterKey_FLOAT_CV());
            ...
            inGL.glTranslatef(0+BaseRoutineRuntime.getInstance().getCurrentStereoscopicEyeSeparation(), -15+BaseGlobalEnvironment.getInstance().getParameterKey_FLOAT_DF(), -60.0f+BaseGlobalEnvironment.getInstance().getParameterKey_FLOAT_CV());
            inGL.glRotatef(180.0f+BaseGlobalEnvironment.getInstance().getParameterKey_FLOAT_GH(), 0f, 1f, 0f);
            inGL.glRotatef(85.0f+BaseGlobalEnvironment.getInstance().getParameterKey_FLOAT_JK(), 1f, 0f, 0f);
            inGL.glRotatef(0.0f+BaseGlobalEnvironment.getInstance().getParameterKey_FLOAT_YX(), 0f, 0f, 1f);                  
        } else if(tCurrentTransform==4) {
            inGL.glTranslatef(0+BaseRoutineRuntime.getInstance().getCurrentStereoscopicEyeSeparation(), -15-7+BaseGlobalEnvironment.getInstance().getParameterKey_FLOAT_DF(), -60.0f+BaseGlobalEnvironment.getInstance().getParameterKey_FLOAT_CV());
            ...
            inGL.glRotatef(0.0f+BaseGlobalEnvironment.getInstance().getParameterKey_FLOAT_YX(), 0f, 0f, 1f);                  
        } else if(tCurrentTransform==5) {
            inGL.glTranslatef(0+BaseRoutineRuntime.getInstance().getCurrentStereoscopicEyeSeparation(), 0, -200.0f);
            inGL.glRotatef(inFrameNumber*0.2f, 0f, 1f, 0f);
            //inGL.glRotatef(inFrameNumber*0.2f, 1f, 0f, 0f);
            //inGL.glRotatef(inFrameNumber*0.3f, 0f, 0f, 1f);
        }
