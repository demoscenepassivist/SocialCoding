...
public class S3D_GL3_Kohlenstoffeinheit_Port extends BaseRoutineAdapter implements BaseRoutineInterface {
    ...
    public void initRoutine(GL2 inGL,GLU inGLU,GLUT inGLUT) {
        int tFragmentShader = ShaderUtils.loadFragmentShaderFromFile(inGL,"/shaders/raymarchingshaders/kohlenstoffeinheit_development_main_s3d.fs");
        mLinkedShaderID_Main = ShaderUtils.generateSimple_1xFS_ShaderProgramm(inGL,tFragmentShader);
        tFragmentShader = ShaderUtils.loadFragmentShaderFromFile(inGL,"/shaders/raymarchingshaders/kohlenstoffeinheit_development_post_s3d.fs");
