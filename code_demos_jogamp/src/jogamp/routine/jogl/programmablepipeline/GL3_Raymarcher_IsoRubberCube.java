 ...
 ** (here an iso-'rubbercube' to be exact). All matrix calculations, object setup and lighting is 
 ** done solely in the fragment shader. Demonstrates the use of a 1D texture as LUT (using TextureUtils)
 ** and also makes use of ShaderUtils to ease the handling of vertex&pixel shaders. For an impression 
 ** how this routine looks like see here: http://www.youtube.com/watch?v=rwjknnoE_ZI
 **
 **/
...
public class GL3_Raymarcher_IsoRubberCube extends GL2_FBO_FullscreenQuad_Base {

    public void init_FBORenderer(GL2 inGL,GLU inGLU,GLUT inGLUT) {
        int tFragmentShader = ShaderUtils.loadFragmentShaderFromFile(inGL,"/shaders/raymarchingshaders/isorubbercube.fs");
