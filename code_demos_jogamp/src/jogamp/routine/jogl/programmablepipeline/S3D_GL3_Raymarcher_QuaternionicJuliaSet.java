...
public class S3D_GL3_Raymarcher_QuaternionicJuliaSet extends GL2_FBO_FullscreenQuad_Base {

    public void init_FBORenderer(GL2 inGL,GLU inGLU,GLUT inGLUT) {
        int tFragmentShader = ShaderUtils.loadFragmentShaderFromFile(inGL,"/shaders/raymarchingshaders/quaternionicjuliaset_s3d.fs");
