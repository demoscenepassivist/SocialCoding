...
public class S3D_GL3_Hartverdrahtet_Port extends BaseRoutineAdapter implements BaseRoutineInterface {
    ...
    public void initRoutine(GL2 inGL,GLU inGLU,GLUT inGLUT) {
        int tFragmentShader = ShaderUtils.loadFragmentShaderFromFile(inGL,"/shaders/raymarchingshaders/hartverdrahtet_development_main_s3d.fs");
        mLinkedShaderID_Main = ShaderUtils.generateSimple_1xFS_ShaderProgramm(inGL,tFragmentShader);
        tFragmentShader = ShaderUtils.loadFragmentShaderFromFile(inGL,"/shaders/raymarchingshaders/hartverdrahtet_development_post_s3d.fs");
    ...
    public void mainLoop(int inFrameNumber,GL2 inGL,GLU inGLU,GLUT inGLUT) {
        ...
        ShaderUtils.setUniform1f(inGL,mLinkedShaderID_Main,"eyeoffset",BaseRoutineRuntime.getInstance().getCurrentStereoscopicEyeSeparation());      
        ...
        ShaderUtils.setUniform1f(inGL,mLinkedShaderID_Post,"eyeoffset",BaseRoutineRuntime.getInstance().getCurrentStereoscopicEyeSeparation());      
        inGL.glBegin(GL_QUADS);
            inGL.glTexCoord2f(0.0f, 1.0f);
            inGL.glVertex2f(0.0f, 0.0f);
            inGL.glTexCoord2f(1.0f, 1.0f);
