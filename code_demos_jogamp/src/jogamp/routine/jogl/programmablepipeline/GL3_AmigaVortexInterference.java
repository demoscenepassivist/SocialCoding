 ...
 **  \/____.                                                                             .____\/     
 **
 ** Another variation of the 'AMIGAAA!!! Circle Interference' routine. Instead of circles
 ** the fragment shader generates a blob pattern wich is afterwards wrapped onto a vortex tunnel.
 ** For an impression how this routine looks like see here: http://www.youtube.com/watch?v=rR04-uzIuRY
 **
 **/
...
public class GL3_AmigaVortexInterference extends BaseRoutineAdapter implements BaseRoutineInterface,BaseFrameBufferObjectRendererInterface {
    ...
    public void init_FBORenderer(GL2 inGL,GLU inGLU,GLUT inGLUT) {
        int tFragmentShader = ShaderUtils.loadFragmentShaderFromFile(inGL,"/shaders/vortexinterference.fs");
